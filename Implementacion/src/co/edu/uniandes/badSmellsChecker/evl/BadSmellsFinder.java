/*******************************************************************************
 * Copyright (c) 2017 Universidad de los Andes
 * Contributors:
 *   Nicolás Bonet Gonzalez - initial implementation
 ******************************************************************************/
...
import co.edu.uniandes.badSmellsChecker.EpsilonStandaloneExample;
import co.edu.uniandes.badSmellsChecker.ProjectInfo;

/**
 * This runs the bad smells finder
...
public class BadSmellsFinder {
	...
	public BadSmellsFinder() throws Exception
	{
		// Contadores
